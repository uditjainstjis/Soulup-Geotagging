...
import {GetUserLocation} from './components/useLocation'
...
export default function Home() {
  ...
  return (
    <div className='mt-2 flex flex-col lg:flex-row'>
      ...
      <h5 className='text-black mb-1  sm:text-lg md:text-xl  bg-slate-50 p-5 mt-3 rounded-full  sm:w-[100vw] md:w-[90vw] lg:w-[65vw] font-semibold font-mono'>Find others around you dealing with the same thing as you.</h5>
