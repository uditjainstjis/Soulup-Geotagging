...
export default function Home() {
  ...
  return (
    <div className='mt-2 flex flex-col lg:flex-row'>
      ...
      <h5 className=' mb-1  sm:text-lg md:text-xl  bg-slate-200/20 p-5 mt-3 rounded-full  sm:w-[100vw] md:w-[90vw] lg:w-[65vw] font-semibold font-mono'>This map shows people who have recently faced the same issue as your's.</h5>
